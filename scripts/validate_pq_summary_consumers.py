...
def main() -> int:
    ...
    checks.update({
        ...
        "skill_unlock_preserves_pq_boundary": "reward trigger, Ultimate Finish status, guarantee, and drop chance must be separately evidenced" in texts["skill_unlock_database"],
        ...
        "farming_hub_preserves_acquisition_uncertainty": "does not treat the existence of a PQ→skill relationship as proof of a guaranteed" in texts["farming_hub"],
