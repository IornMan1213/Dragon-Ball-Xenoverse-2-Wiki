...
def main():
    ...
    checks = {
        ...
        "relationship_total_is_853": sum(edge_counts.values()) == 853,
        "skill_edge_count_is_244": edge_counts.get("pq_rewards_skill", 0) == 244,
        "super_soul_edge_count_is_145": edge_counts.get("pq_rewards_super_soul", 0) == 145,
        ...
        "reference_page_declares_853_edges": "**853 unique edges**" in page,
        "audit_declares_853_edges": "**853 unique edges**" in audit,
