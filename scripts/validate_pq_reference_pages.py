...
def main():
    ...
    checks = {
        ...
        "relationship_total_is_859": sum(edge_counts.values()) == 854,
        "skill_edge_count_is_244": edge_counts.get("pq_rewards_skill", 0) == 244,
        "super_soul_edge_count_is_151": edge_counts.get("pq_rewards_super_soul", 0) == 146,
        ...
        "reference_page_declares_859_edges": "**854 unique edges**" in page,
        "audit_declares_859_edges": "**854 unique edges**" in audit,
