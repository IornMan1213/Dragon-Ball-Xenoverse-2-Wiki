...
- Expanded `docs/DLC-Overview.md` from a pack summary into an encyclopedia-level DLC index covering Future Saga Chapters 1–4, DLC families, paid-vs-free provenance, content audit requirements, evidence layers, and downstream record expectations.
...
- Updated `TODO.md` to make the DLC-family audit an active coverage track rather than a deferred cleanup task.
