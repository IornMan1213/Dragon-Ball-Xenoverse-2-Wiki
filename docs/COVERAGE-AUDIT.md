...
- Added direct PQ171 evidence for Crimson Edge and Divine Spear. The Steam guide independently lists both as Basic Rewards for PQ171; a dedicated PQ171 gameplay guide also documents unlocking both skills. 
...
- Recomputed the live skill census before editing: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable `ki_cost` / 45 exactly-two-source records**.
...
- Recomputed the live skill census before editing: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable `ki_cost` / 42 exactly-two-source records**.
- Strengthened **Final Charge (`skill-final-charge`)** from two to three provenance sources with MeriStation's July 2019 Ultra Pack 1 coverage, independently identifying Final Charge among SSGSS Evolved Vegeta's skills and placing the character in Ultra Pack 1.
...
- Live pre-edit census: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable `ki_cost` / 41 exactly-two-source records**.
...
- Live pre-edit census: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable ki_cost / 37 exactly-two-source records**.
- Strengthened **Gigantic Explosion (skill-gigantic-explosion)** from two to three sources with Videogaming Wiki's Xenoverse 2 entry, independently confirming its Future Saga Chapter 1 introduction, PQ **Where Is Goku?!**, Broly users, Awoken Skill mechanic, and 400 Stamina continuation behavior.
- The maintained PQ guide independently lists Gigantic Explosion among PQ164's **Basic Rewards**. Existing repository semantics record the specific Ultimate Finish (40%) acquisition condition; neither added source was used to overwrite or reinterpret that condition.
...
- Post-write live census: **36 exactly-two-source records**.
...
- Live pre-edit census: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable ki_cost / 35 exactly-two-source records**.
...
- Refreshed `last_verified` to **2026-09-21** and synchronized canonical/index records.
- Post-write census: **34 exactly-two-source records**.

## 2026-09-21 — Godly Chronos Cannon low-source provenance strengthening
- Live pre-edit census: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable ki_cost / 34 exactly-two-source records**.
...
- Enriched 10 canonical equipment records with independent identity/category provenance and explicit PQ/DLC provenance.
- Batch categories: 041–042 accessory; 043 equipment; 044 accessory; 045–046 equipment; 047 accessory; 048–049 equipment; 050 accessory.
- Validation: 169 canonical equipment records, 0 duplicate IDs; PQ→equipment 124 forward / 122 reverse / 0 unresolved / 0 broken endpoints.
...
- Validation remains clean: 169 canonical equipment records, 0 duplicate IDs; PQ→equipment 124 forward / 122 reverse / 0 unresolved / 0 broken endpoints.
- Unsupported reward probabilities, slot semantics, restrictions, and effects remain unresolved.
- Next exact batch: **`equip-071`–`equip-080`**.

### 2026-09-22 — Equipment provenance batch `equip-071`–`equip-080` range
- Enriched the 8 standalone canonical records in the requested range with independent equipment-catalog provenance and base-game classification.
...
- Post-batch validation recomputed the PQ→equipment relationship layer at **125 forward / 123 reverse / 0 unresolved / 0 broken endpoints**, not 129 forward. The canonical endpoint parity remains pass.
- The prior batch narrative's 129-forward figure is superseded by this live recomputation; historical wording is retained for auditability.
...
- Audited **247 character relationship edges / 75 unique targets** against the canonical character identity layer: **75/75 resolve**, with 5 documented aliases retained and 0 missing canonical endpoints.
- Audited **88 DLC relationship edges / 21 unique targets** and found one case-only reverse-index duplicate for PQ185/PQ186.
