...
- Research/evidence: current Xenoverse 2 skill references explicitly list **100 Ki** for God Splitter, **100 Ki** for Heavenly Arrow, and **300 Ki** for Instant Severance. The mentor reference independently confirms all three as Zamasu rewards. citeturn0search0turn0search1turn0search2turn0search5
- Changes: populated only canonical `ki_cost` and refreshed `last_verified=2026-09-21`; no mechanics, acquisition, restriction, or variable-cost semantics were inferred.
...
## 2026-09-21 Ultra Pack 2 skill provenance census

- Audited all **8** canonical Ultra Pack 2 skills.
...
\n\n### 2026-09-21 — Future Saga Chapter 3 skill completeness correction\n- Live canonical skill census before editing: **429 records / 0 duplicate IDs / 0 nullable `ki_cost` values**.\n- Official Bandai Namco DLC scope states Future Saga Chapter 3 contains **3 Parallel Quests and 6 additional moves**. Independent current technique/mission evidence identifies the six as Gigantic Cross, Gigantic Nova, Saiyan Blaster, Emperor's Cannon, Dark Inscription, and Chaotic Time Impact.\n- The live canonical registry contained only the three PQ-linked endpoints (Emperor's Cannon, Dark Inscription, Chaotic Time Impact); **Gigantic Cross, Gigantic Nova, and Saiyan Blaster were missing canonical endpoints** despite being documented Chapter 3 moves obtained through Conton City Patrol 04, 17, and 10 respectively.\n- Added the three missing canonical records with bounded acquisition provenance and directly evidenced costs/classifications: Gigantic Cross (100 Ki Super), Gigantic Nova (300 Ki Ultimate), and Saiyan Blaster (400 Stamina Ki Blast Evasive). No unsupported PQ reward gate or narrower CaC race/gender restriction was inferred.\n- Projected all three records into `docs/data/skills-index.json` and synchronized category counts.\n- Validation: **432 canonical / 432 index / 0 duplicate IDs / 0 nullable `ki_cost` values**; Future Saga Chapter 3 now has **6 canonical skill records**, matching the official six-move package scope.\n- Evidence sources: official Bandai Namco DLC reference; current dedicated skill references; maintained Cheelai & Broly Conton City Patrol mission listing.\n- CI: inspect the new canonical/index commits for exposed workflow runs/checks; no CI success is claimed unless GitHub exposes an actual run/status.\n- Commits: canonical `90c38fc82cba07d0dc557aca1f92d539c0c4dbf5`; index `8ea4b572b601ad9b94652ff888203751d0ee812a`.\n- Exact next batch: **recompute the live DLC-label/source-relationship census after the Chapter 3 completeness correction and select the next deterministic character-only/DLC cluster with a concrete missing endpoint or provenance mismatch; do not reopen Chapter 3 unless new contradictory evidence appears.**\n
### 2026-09-21 — Free Update 11 skill completeness correction
- Live canonical skill census before editing: **432 records / 432 index records / 0 duplicate IDs / 0 nullable `ki_cost` values**.
- Official/current Free Update 11 documentation identifies **9 new skills**: Holy Inscription, Kairos Cannon, Temporal Holy Ray, Chaos Wall, Timespace Impact, Godly Chronos Cannon, Soaring Fist, Divine Kamehameha, and Godly Display.
- The canonical registry already contained Divine Kamehameha and Godly Display, but was missing the other **7** Free Update 11 endpoints.
...
### 2026-09-21 — Free Update 2 index-order parity correction
- Post-audit verification found canonical/index ID sets equal at 448/448 but record ordering diverged.
...
\n\n### 2026-09-21 — Dragon Ball DAIMA Pack skill provenance correction\n- Live skill census before correction: **448 canonical records / 0 duplicate IDs / 0 nullable `ki_cost` values**.\n- Deterministic mismatch found in the Future Saga Chapter 2 cluster: **Supreme Fury** and **Heat Wave** were labeled Future Saga Chapter 2 but are used by SS4 Goku (DAIMA) and are rewards in **PQ179, 24/7 Time Patrol**, which is explicitly a Dragon Ball DAIMA Pack quest.\n- Current DLC reference documents the Dragon Ball DAIMA Pack as containing **6 skills**, including Supreme Fury and Heat Wave, while the canonical registry previously counted only 4 DAIMA Pack skills and 9 Future Saga Chapter 2 skills.\n- Corrected only `dlc_requirement` for the two records and refreshed their verification date/provenance note. No cost, acquisition, reward-tier, mechanics, or restriction fields were changed.\n- Post-write validation: **448 canonical records / 0 duplicate IDs / 0 nullable `ki_cost` values / 6 Dragon Ball DAIMA Pack records / 7 Future Saga Chapter 2 records**.\n- Evidence: current DLC inventory and maintained 186-PQ Steam guide identify both skills in the DAIMA Pack/PQ179 scope.\n- Canonical commit: `1cdf20c103463f864443ad42960b157efb1d3e2f`.\n- Exact next task: continue the live DLC/free-update source census and identify the next concrete character-only, package-count, or provenance mismatch; preserve already reconciled clusters.\n

### 2026-09-21 — Free Update 1 four-attack completeness correction
- Live canonical skill census before editing: **448 canonical / 448 index / 0 duplicate IDs / 0 nullable `ki_cost` values**.
- Official Bandai Namco launch-update documentation confirms **four additional attacks** in Free Update 1 but does not name them individually. A contemporaneous December 2016 GameFAQs discussion identifies the four TP Medal Shop additions as **Chaos Shot, Galick Cannon, Impulse Slash, and Secret Poison**; current dedicated skill references independently confirm the TP Medal Shop route.
