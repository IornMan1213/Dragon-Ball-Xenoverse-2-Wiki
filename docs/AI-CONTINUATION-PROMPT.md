...
### 2026-09-19 continuation — explicit UF evidence found
- **Ultrasonic Blitz** (PQ151) was resolved to `ultimate_finish_required=true` using dedicated acquisition evidence that explicitly identifies it as a PQ151 Ultimate Finish reward.
