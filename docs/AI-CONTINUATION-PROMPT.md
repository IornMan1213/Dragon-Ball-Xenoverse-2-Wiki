...
- External verification: the official Bandai Namco DLC catalog distinguishes the Ultra Pack Set, while current DLC documentation identifies Ultra Pack 1 as DLC 9 and lists PQ 134 plus Burst Charge and Ultimate Charge.
...
- Android 15: added canonical `accr-105` = **Android 15's Shades & Hat**. Current equipment references explicitly identify this as a single accessory available from the TP Medal Shop; the research label 'Sunglasses' is preserved as an alias/component description.
- Android 17: linked `pqacc-029` to existing `accr-029` = **Android 17 (DB Super) Wig** as a component/research alias. PQ152 reward evidence explicitly lists the wig. No duplicate inventory record was created.
- Android 14's Hat and Bardock (DB Super)'s Scouter remain unresolved. PQ104 evidence lists Android 14's Clothes; PQ146 evidence lists Bardock (DB Super)'s Clothes, so neither PQ route proves the requested accessory identity.
...
- Evidence confirms PQ104's documented reward is **Android 14's Clothes**, and PQ146's documented reward is **Bardock (DB Super)'s Clothes**. Current equipment references do not establish separate exact canonical accessory identities for the two research labels.
...
- Evidence: current mentor references document the exact four rewards for Piccolo, Tien, Yamcha, Nappa, and Raditz; the GameFAQs mentor list independently corroborates the same lesson sequences.
...
- Evidence: mentor reward lists corroborate exact lesson order and classifications, including Turles (Sudden Storm, Kill Driver, Fruit of the Tree of Might, Meteor Burst), Broly (Blaster Shell, Blaster Meteor, Gigantic Omega, Gigantic Meteor), Beerus (God of Destruction's Anger, Rampage, Wrath, Sphere of Destruction), and Whis (Finishing Blow, Prelude to Destruction, Strike of Revelation, Symphonic Destruction).
...
### 2026-09-21 cycle update — Android 16 / Future Gohan / Bojack canonical skill expansion
- Workstream: P1 mentor acquisition → canonical skill expansion and bidirectional relationship completion.
- Research performed: live mentor/skill census; Android 16, Future Gohan, and Bojack lesson endpoint audit; independent instructor-guide corroboration; Fandom mentor/skill pages; partner-customization data; independent mentor documentation. Search evidence establishes Android 16's Eye Beam/Rocket Tackle/Android Rush/Hell Flash, Future Gohan's Super Explosive Wave/Sonic Rush/Energy Dome/One-Handed Kamehameha mk.II, and Bojack's Reverse Launcher/Trap Shooter/Psycho Barrier/Grand Smasher. Internal web citation markup was not copied into repository files.
- Changes: `docs/data/skills.json`, `docs/data/skills-index.json`, `docs/data/mentors-record-layer.json`, `docs/data/mentor-skill-coverage-report.json`, `CHANGELOG.md`.
- Added 11 canonical skill records and reused Super Explosive Wave. Future Gohan now has a complete four-lesson record layer. Multi-mentor provenance for Super Explosive Wave is preserved instead of duplicating the skill.
- Evidence limits: no unsupported Ki/stamina costs, drop rates, or extra acquisition gates were invented. Classification and lesson identity are recorded where directly corroborated; combat mechanics remain deferred for later evidence enrichment.
- Validation: **408 skills / 408 index records / 408 taxonomy total / 133 mentor lessons / 120 resolved edges / 13 unresolved endpoints / 28 fully linked mentors / 4 partially linked mentors / 0 duplicate canonical IDs / 0 internal citation artifacts.**
- Important consistency correction: skill taxonomy counts were recomputed from the live 408 records and synchronized into both canonical and index files.
- CI: no new workflow result was claimed; prior repository workflow lookup behavior remains opaque/no actionable run data. Validators were not weakened.
- Commits: `d154caf890d6a955437c6c6af1184407de2a1729` (skills), `58bb94e8b991f8c4969d7d80b850abc5e1489505` (skill index), `0d90168c74d866b36a411c1c505bcb88c500f2eb` (mentor layer), `4a97dbb9129d82d139ac4deb28dab91edd586713` (coverage), `79a21e9863a1aad8ee70446d3f547d12dc291c1b` (taxonomy correction), `c2a273c21c0d7f2c944f341fed18475ee6d06ecb` / `5fa8ea79043c98ac7039d99bb659b36ce048ba92` / `e97f2fe6c3f8a9da0794268565586a37b4964f22` (Future Gohan lesson/coverage/index synchronization), plus the changelog and this handoff update.
- Exact next batch: **Zamasu, Hit, Vegeta, and Gohan (Kid)**. Audit their unresolved mentor lesson endpoints against canonical skill records. Reuse existing records where exact identity is established; add missing records only with evidence; preserve unresolved endpoints when exact identity cannot be established. Then synchronize canonical skills, skill index, mentor layer, and coverage report and rerun the full graph census.


### 2026-09-21 cycle update — Zamasu / Hit / Vegeta / Gohan (Kid) canonical skill expansion
- Workstream: P1 mentor acquisition → canonical skill expansion and bidirectional relationship completion.
- Research performed: live mentor census plus independent skill/mentor sources. Zamasu's four mentor rewards were corroborated; its initiation reward `I'm thinking of becoming a GodTuber` is a Super Soul, not a skill. Hit's `Time Skip/Tremor Pulse` was directly verified as a Strike Evasive learned through Hit's Lesson 3. Vegeta's Finish Breaker/Flash Strike/Final Flash and Kid Gohan's Evil Ray Strike/Evil Rise Strike/Masenko/Explosive Assault were independently corroborated.
- Added 10 canonical skills and synchronized `skills.json`, `skills-index.json`, `mentors-record-layer.json`, and `mentor-skill-coverage-report.json`.
- Evidence limits preserved: no unsupported costs, drop rates, or conditional requirements were fabricated. The Zamasu Super Soul remains an explicit unresolved non-skill endpoint rather than being forced into the skill database.
- Validation: **418 skills / 418 index records / 418 taxonomy total / 133 mentor lessons / 130 resolved edges / 3 unresolved endpoints / 31 fully linked mentors / 2 partially linked mentors / 0 duplicate canonical IDs.**
...
- Research confirmed Krillin's Xenoverse 2 mentor sequence is Rise to Action → Orin Combo → Destructo-Disc → Scatter Kamehameha. `Spread Shot Retreat` is a separate Evasive in Krillin's moveset and was not incorrectly modeled as a mentor lesson reward.
...
### 2026-09-21 cycle update — PQ ↔ skill canonical graph reconciliation
- Workstream: P1/P2 cross-database relationship integrity; deterministic PQ → skill and skill → PQ navigation.
- Live census before editing: **429 canonical skills / 429 skill-index records / 186 canonical PQ records**. The existing PQ-skill report claimed 236 forward / 236 reverse edges, but the live skill registry carried 244 source_parallel_quests endpoints; the report was therefore stale relative to later canonical skill expansion.
- Bounded batch: reconciled docs/data/parallel-quests-record-layer.json and docs/data/pq-skill-crosslink-report.json against the current canonical skill registry.
- Research/evidence: inspected the current canonical PQ reward layer and each affected skill's source_parallel_quests, source_quest, and acquisition fields. The nine reverse-only skill endpoints were all directly represented by canonical PQ reward/reward-name data; the remaining report-only edges were reconciled from existing canonical skill provenance. No relationship was inferred from enemy appearance alone.
- Changes: added the missing canonical PQ skill_ids/skill_rewards endpoints needed for PQ11–14, PQ46, PQ49, PQ57, PQ66, PQ86–87, PQ106, PQ113, and PQ176; rebuilt pq-skill-crosslink-report.json from the canonical PQ/skill registries.
- Validation: **244 forward / 244 reverse / 0 unresolved / 0 orphaned** PQ↔skill edges; **429 canonical skills** remain synchronized with the skill registry. JSON was parsed after each write; final graph census is bidirectional with no unresolved endpoints or orphaned reverse sources. No internal citation artifacts were introduced.
- CI: commit-associated workflow lookup for the changed commits exposed **no workflow runs and no status checks**; no CI success is claimed. Validators were not weakened.
- Commits: 0030856e33ee49182d55797ce115bb1ae3a6a216 (PQ endpoint synchronization), caaad6abe711ef44a69ad9525f5b71b631b74a92 (PQ113 completion), 294eb1eb2820a2169dfc8d38bc2eb9e67cb53775 (crosslink report rebuild), f2c2f53a58e93a4596de140f941e0ebf603ac813 (changelog).
- Related live state observed: the latest repository commits are already advancing the Super Soul relationship work through canonical records 001–047; the 024–047 continuation note reports 42 canonical Super Soul records and a 11/11 existing PQ↔Super Soul crosslink state. This cycle did not overwrite that work.
- Exact next batch: **continue the cross-database PQ reverse-domain audit with the Super Soul corpus immediately after the existing 001–047 frontier**. First inspect the live Super Soul layer and its relationship report, identify the next source-backed canonical batch after 047, then synchronize PQ↔Super Soul forward/reverse edges without inventing IDs or acquisition routes. Preserve the current 11/11 verified relationship state as the baseline.

### 2026-09-21 cycle update — Super Soul 048-055 and PQ reverse-link reconciliation
- Workstream: P1/P2 cross-database relationship integrity; continue the Super Soul frontier after the existing 001-047 state.
- Live census before editing: 42 canonical Super Soul records / 186 canonical PQ records; the existing PQ↔Super Soul report contained 11 forward and 11 reverse edges.
- Bounded batch: Super Soul 048-055, plus deterministic PQ relationship synchronization for the complete currently PQ-sourced Super Soul subset.
- Research/evidence: consulted the maintained Madreag final-DLC-era Super Soul corpus and its linked game-file/Fandom provenance for the eight new records. The eight added records are 40 ton weights!, Killed all Earthlings!, That's one down!, That offer's expired..., Why are you dodging?!, Guess you CAN fight..., Leave my daddy alone!, and Leave the rest to me!. The source corpus establishes exact effect text and acquisition identity; limited-time raid identities remain community-supported where noted in the canonical records.
- Changes: docs/data/super-souls-record-layer.json now has 50 canonical records and an explicit source_parallel_quests field. Added super-soul-048 through super-soul-055. docs/data/parallel-quests-record-layer.json now exposes super_soul_ids and super_soul_rewards for PQ58 and PQ131. docs/data/record-expansion-contract.json formalizes the PQ↔Super Soul fields. docs/data/pq-super-soul-crosslink-report.json was rebuilt from the live 50-record Super Soul registry.
- Validation: 50 canonical Super Soul records; 13 forward / 13 reverse PQ↔Super Soul edges; 11 unique PQ endpoints; 13 unique Super Soul endpoints; 37 Super Soul records remain without an explicit PQ endpoint; 0 broken forward endpoints; 0 broken reverse endpoints; 186 canonical PQ records; all changed JSON parsed successfully.
- Evidence limits preserved: no PQ relationship was inferred from enemy appearance or theme. Exact 50% reward rolls were retained only for Super Soul 049 (PQ58) and Super Soul 055 (PQ131), where the consulted source corpus explicitly states them. Raid/shop/story routes remain provenance-labeled rather than broadened into unsupported conditions.
- Internal citation artifact check: all changed JSON files contain 0 internal UI/search citation artifacts. CHANGELOG.md contains pre-existing historical citation markup elsewhere; this cycle did not add such markup to canonical JSON.
- CI: combined status checks for the five direct data/contract commits exposed no statuses; no CI success is claimed. Validators were not weakened.
- Commits: b4a3f97c6ba5aa356f1d587515082fb02a724fd6 (Super Soul 048-055); 516ef82d4b861aa9832fdebbe0e9772adf5a928f (PQ58/PQ131 endpoints); e3680573439a06037fdcadc3a9bb9295c6a58b52 (Super Soul reverse PQ endpoints); 1a42e6f416b6369a6181fa6232b185801b619e24 (relationship contract); 57cd54f3eab3075af8648fbaa2a6584402422c12 (crosslink report); d8b050b79eadc805c70cafdc0ae384389be6d087 (changelog).
- Exact next batch: continue the Super Soul canonical frontier with the next 8 source-backed records after 055, assigning stable IDs 056-063 only after live-corpus reconciliation. Start with: I refuse to give up; Can I attack now?; Now I'm MAD!; I-I'm sorry!; I...hate you!!!; Is that all?; Damn it all; Zudodoeyaahh. For each, establish acquisition identity first, then add only deterministic PQ/EM/shop/raid/story endpoints and update the reverse report. Preserve nulls and conflicts.

### 2026-09-21 cycle update — Super Soul 056-063 + PQ reverse-link reconciliation
- Live census before editing: **50 canonical Super Soul records / 186 canonical PQ records**. Existing PQ↔Super Soul report: **13 forward / 13 reverse / 37 unresolved Super Soul routes**.
- Bounded batch: **Super Soul 056-063** — I refuse to give up..., Can I attack now?, Now I'm MAD!, I-I'm sorry!, I...hate you!!!, Is that all?, Damn it all!, and Zudodoeyaahh!.
- Research/evidence: inspected the maintained Madreag final-DLC-era Super Soul corpus for each exact record and reused its linked game-file/Fandom provenance. PQ identities were accepted only where the source corpus explicitly named the quest; raid identities remain community-supported where stated.
- Changes: added `super-soul-056` through `super-soul-063`; added deterministic `source_parallel_quests` endpoints for PQ93, PQ160, and PQ180; synchronized those PQ records with `super_soul_ids` / `super_soul_rewards`; rebuilt `docs/data/pq-super-soul-crosslink-report.json`.
- Validation: **58 canonical Super Soul records / 16 forward / 16 reverse PQ↔Super Soul edges / 14 unique PQ endpoints / 16 unique Super Soul endpoints / 42 unresolved Super Soul routes / 0 broken relationship endpoints**. Changed JSON parsed successfully. No generated Super Soul index was found in the live repository, so no unsupported index projection was created.
- Evidence limits/conflicts preserved: `I...hate you!!!` retains the official Charged Ki Blast Skills wording while the community-tested broader scope remains provenance in the source record; community percentages/durations were not promoted to canonical exact values. No relationship was inferred from character appearance or quest theme.
...
### 2026-09-21 cycle update — Super Soul 096–103 live-corpus correction + PQ reverse-link reconciliation
- Workstream: P1/P2 Super Soul canonical expansion and deterministic PQ↔Super Soul relationship integrity.
- Live census before editing: **90 canonical Super Soul records / 186 canonical PQ records**. The previous handoff's proposed 096–103 names were already present under earlier canonical IDs, so the batch was corrected from the live source corpus instead of duplicating records.
- Bounded batch: **Super Soul 096–103** — It must be some kind of trick..., It all comes down to this!, I'll keep adding a bit of power to my attacks!, You're not much of a fun fight!, I think I'm getting the hang of this., I will put a stop to you, fiend!, There's more where that came from!, and Emoc htorf! Peas and Carrots!.
- Research/evidence: reconciled the maintained Madreag scripts/data/super-souls.json corpus, its item-level Super Soul pages, and current independent references. The exact named PQ routes are PQ151 for 098/100, PQ152 for 101, and PQ153 for 099/102. Raid/event sources for 096/097/103 remain acquisition identities only; no recurrence schedule was inferred.
- Changes: added super-soul-096 through super-soul-103 to docs/data/super-souls-record-layer.json; synchronized PQ151–153 with super_soul_ids / super_soul_rewards in docs/data/parallel-quests-record-layer.json; rebuilt docs/data/pq-super-soul-crosslink-report.json from the canonical Super Soul registry; updated docs/COVERAGE-AUDIT.md and CHANGELOG.md.
- Evidence limits/conflicts preserved: community-measured percentages/durations remain non-canonical context; no unsupported raid recurrence, drop rate, or acquisition route was invented. Existing source-text behavior disputes remain bounded in record notes.
- Validation: **98 canonical Super Souls / 186 canonical PQ records / 34 forward / 34 reverse PQ↔Super Soul edges / 28 unique PQ endpoints / 34 unique Super Soul endpoints / 64 unresolved Super Soul routes / 0 broken forward or reverse endpoints**. All three changed JSON files parsed successfully and changed JSON contained **0 internal UI/search citation artifacts**.
- CI: commit-associated workflow lookup for the changelog commit returned **no workflow runs**; no CI success is claimed. Validators were not weakened.
- Commits: d826ffadd05bdae7deaa628e09c8da90ac9e9671 (canonical Super Souls 096–103); c28bec2622807bf55483a98a22d7925844883e78 (PQ151–153 endpoints); 6027a55c5b630a13d48fef02b32a4dc9ee3583b6 (crosslink report rebuild); 1ce4e9bdc936ee1f8ff01eff5c18e4a811660837 (coverage audit); ae6ef363f37cc8185bbda4bacbb60d0df06c799e (changelog).
- Exact next batch: **Super Soul 104–111**, after another live-corpus reconciliation. The next unique source-backed frontier is currently: Looks like I mixed up the capsules...; I'll be the one to fight you!; This is your true power?; You need to be more careful.; Still haven't figured out you're gonna lose?; Heh heh! I'm not as rusty as I look!; See? It's a good thing I was here, right?; I can tell you're an amateur by the way you pose!.


### 2026-09-21 cycle update — Super Soul 104–111 + PQ reverse-link reconciliation
...
- Research/evidence: exact next eight unique records from the maintained Madreag scripts/data/super-souls.json frontier; GitHub source-page searches confirmed source slugs and acquisition identities. Explicit PQ routes: 105/107 → PQ157; 106/108 → PQ156; 109/110 → PQ158. 104 and 111 remain raid-event records without inferred PQ linkage.
- Changes: added super-soul-104 through super-soul-111; synchronized PQ156–158 super_soul_ids / super_soul_rewards; rebuilt docs/data/pq-super-soul-crosslink-report.json; updated docs/COVERAGE-AUDIT.md and CHANGELOG.md.
- Evidence limits/conflicts preserved: no unsupported raid recurrence, drop-rate, or quest relationship was invented. Community-measured values remain bounded by verification notes.
- Validation: **106 canonical Super Souls / 186 canonical PQ records / 40 forward / 40 reverse PQ↔Super Soul edges / 31 unique PQ endpoints / 40 unique Super Soul endpoints / 66 unresolved Super Soul routes / 0 broken endpoints**. All three changed JSON files parsed successfully and contain **0 internal UI/search citation artifacts**.
...
### 2026-09-21 cycle update — skill-index deterministic projection cleanup (last_verified, source_parallel_quests, sources)
- Workstream: **P1 skill acquisition/DLC-version provenance cleanup**, deterministic generated-index reconciliation after the prior mentor/DLC provenance work.
- Live census: **429 canonical skills / 429 skill-index records**.
- Bounded work completed across three tightly scoped projection families: **20 `last_verified` values** (two existing 10-record batches plus the final 10-record batch: Rise to Action, Shadow Crusher, Spirit Bomb, Super Spirit Bomb, Supernova, The Power to Overcome, Time Skip/Back Breaker, Time Skip/Flash Skewer, Time Skip/Jump Spike, Venus Fist); **5 `source_parallel_quests` values** (Candy Beam, Kamehameha, Mach Dash, Time Control, Warp Kamehameha); and **3 `sources` arrays** (God Splitter, Heavenly Arrow, Instant Severance).
- Evidence: canonical `docs/data/skills.json` is the producer for these projected values. No new gameplay, acquisition, mechanics, restriction, or DLC claim was invented.
- Validation: canonical and index JSON both parse with **429/429 records**. Live targeted parity is now **0 mismatches for `last_verified`, 0 for `source_parallel_quests`, and 0 for `sources`**. Changed index artifact scan: **0 internal AI/UI/search citation artifacts**.
- CI: combined status and commit workflow-run lookup exposed **no statuses and no workflow runs** for the cycle commits; **no CI success is claimed**. Validators were not weakened.
- Commits: `0865f3d3f7a7281c81effdd0b27e6d7cb2cdd76a` (last_verified), `6ebbd03012647d17aab5a0e25570f8e39fe5958d` (coverage audit), `bbee1b8506d1272abfdf989cfe1a0ace0e7e4c3a` (changelog), `69404599e87914ea5dafe993a154d1e86b0312c9` (source_parallel_quests), `a9b510f8947eaf5695d67065f9d3a3631568cee2` (coverage audit), `1a7af500e04bb3cc23da61a1a8acb2f88a9ac612` (changelog), `20b6a147dae05e99a4b6aa218586709a23f55115` (sources), `d77be59ae8384c55e88a8f95fd986788d4f8ab26` (coverage audit), `b231fd035da5b56a63d9cf21943e948d1855f5cc` (changelog).
- Current remaining deterministic projection drift in the inspected families: **4 `notes` mismatches** and **34 `mechanics_notes` mismatches**; other inspected families are clean. The four `notes` mismatches are God Splitter, Heavenly Arrow, Instant Severance, and Time Skip/Tremor Pulse, where canonical notes contain the documented DLC-provenance refinement that the index has not yet projected.
- Exact next batch: **God Splitter, Heavenly Arrow, Instant Severance, and Time Skip/Tremor Pulse — reconcile only the `notes` projection against canonical `docs/data/skills.json`, then re-run the full live projection census and artifact scan.**


### 2026-09-21 cycle update — skills-index mechanics projection parity batch 1
- Workstream: **P1 skill acquisition/DLC-version provenance cleanup**, deterministic canonical→index projection reconciliation after completing the mentor relationship layer and the prior source/provenance projection families.
- Live census before editing: **429 canonical skills / 429 skill-index records**.
- Bounded batch: **10 `mechanics_notes` projections** — Brutal Buster, Crush Cannon, Crush Stream, Dancing Parapara, Darkness Rush (Melee), Darkness Rush (Ranged), Data Input, Deadly Dance, Death Ball, and Destructive Fission.
- Evidence: canonical `docs/data/skills.json` is the producer for the current index projection; this pass introduced no new gameplay, acquisition, restriction, DLC, or mechanics claim.
- Changes: copied only the canonical `mechanics_notes` values into the matching `docs/data/skills-index.json` records; no unrelated projection fields were regenerated.
- Evidence limits: deterministic cross-layer parity correction, not a new verification event. Remaining live projection drift is **36 field mismatches** across the currently audited projection families: **25 `mechanics_notes`**, **5 `notes`**, and one each of `unlock_method`, `last_verified`, `race_restriction`, `sources`, `source_quest_or_shop`, and `acquisition_type`. The broader drift remains bounded and is not being silently normalized.
- Validation: both JSON layers parsed; **429/429** record counts remain unchanged; all 10 targeted `mechanics_notes` values now match canonical; changed index contains **0 internal AI/UI/search citation artifacts**.
...
### 2026-09-21 cycle update — PQ141-PQ150 research-range repair
- Workstream: **P1 Parallel Quest reward/acquisition/version reconciliation after skill-layer cleanup**.
- Live canonical PQ census: **186 records**. Audit of the legacy research-batch files found a structural gap: all ten records **PQ141-PQ150** were absent from the research-batch layer, leaving 176 researched records despite 186 canonical records.
- Added `docs/data/parallel-quest-research-batches/pq-batch-141-150.json` containing all ten records, individual source arrays, DLC associations, objectives, documented rewards, and conservative DLC-era unlock wording. Steam's maintained all-PQ guide independently documents the ten quests, their DLC groupings, objectives and basic rewards. Exact reward/drop percentages remain unresolved unless directly established.
- Reconciled **PQ144**: canonical rewards were explicitly marked incomplete and omitted Gine (DB Super)'s Clothes, Gine (DB Super) Set, and Artwork 90. Those documented rewards are now restored in the canonical record and synchronized into the new research batch.
- Validation: canonical PQ layer **186/186**; missing research range **141-150** repaired; new batch **10/10**; PQ144 canonical/batch reward lists match; no validator changes or weakening.
- CI: no actionable workflow/status result exposed; **no CI success claimed**.
...
- Evidence: current Xenoverse 2 skill references explicitly expose those Ki-used values.
...
- Researched **Emperor's Death Beam** specifically. Current skill documentation identifies it as a Resurrection 'F' DLC skill; the maintained DLC Pack 3 guide lists Emperor's Death Beam among the Resurrection 'F' content and identifies its PQ acquisition context. Sources consulted: Dragon Ball Wiki's Emperor's Death Beam reference and the maintained Steam DLC Pack 3 guide.
...
- TODO synchronization: appended a permanent dated [x] completion entry to `docs/TODO-EXHAUSTIVE.md` and removed internal citation markup from the new ledger text.
...
### 2026-09-21 cycle update — PQ21-PQ30 reward reconciliation
- Workstream: **P1 Parallel Quest reward/acquisition/version reconciliation**.
- Live census before editing: **186 canonical PQ records / 186 PQ research-batch records / 0 missing research records / 0 duplicate quest numbers**.
- Bounded batch: **PQ21-PQ30**. Compared every canonical reward, skill_reward, equipment_reward, and super_soul_reward field against `docs/data/parallel-quest-research-batches/pq-batch-03.json`.
- Research/evidence: the maintained PQ21-PQ30 research batch provides explicit basic-reward inventories for all ten records, including Evil Flight Strike; Energy Shot; Death Slash; Double Death Slicer; Spirit Explosion; Crazy Finger Shot; Sauzer Blade; Spread Shot Retreat; Freedom Kick; Energy Field; and the non-skill rewards attached to the same quests. The canonical PQ layer already contains the corresponding documented rewards and relationship IDs.
- Result: **no canonical reward correction was required in this bounded batch**. PQ21-PQ30 canonical rewards and skill/equipment/Super Soul relationship fields already agree with the maintained research batch. This cycle therefore changed documentation only rather than rewriting already-correct data.
- Evidence limits preserved: the research batch explicitly leaves exact reward-slot/drop percentages unresolved. No Ultimate-Finish-only reward gate or probability was inferred from the presence of a reward in the basic-reward inventory. Existing canonical relationship fields were not broadened beyond source-backed evidence.
- Validation: PQ research coverage remains **186/186**, with **0 missing / 0 duplicate** quest numbers. PQ21-PQ30 reward inventories were re-read against the research batch and found synchronized. No internal AI/UI/search citation markup was added to repository data.
...
\n\n### 2026-09-21 continuation — Dragon Ball DAIMA Pack provenance correction\n- Workstream: **P1 skill DLC/free-update provenance and character-only completeness cleanup**.\n- Live census before editing: **448 canonical skill records / 0 duplicate IDs / 0 nullable `ki_cost` values**.\n- Deterministic mismatch: **Supreme Fury** and **Heat Wave** were labeled `Future Saga Chapter 2`, but current DLC evidence places both in the **Dragon Ball DAIMA Pack** and the maintained PQ corpus lists both as rewards in **PQ179, 24/7 Time Patrol**.\n- The DAIMA Pack now has **6 canonical skill records**, matching its documented six-skill package scope; Future Saga Chapter 2 now has **7** canonical skill records, matching its documented seven-skill scope.\n- Changes: corrected only the two `dlc_requirement` values and refreshed `last_verified` plus bounded provenance notes. No acquisition, cost, mechanics, reward-tier, or restriction fields were rewritten.\n- Validation: **448 canonical / 448 index / 0 duplicate IDs / 0 nullable `ki_cost` / 6 DAIMA Pack / 7 Future Saga Chapter 2**. The index was not modified because it does not represent `dlc_requirement`.\n- Evidence limitations: this is a package/source-provenance correction; it does not resolve any unrelated acquisition or reward semantics.\n- Canonical commit: `1cdf20c103463f864443ad42960b157efb1d3e2f`.\n- CI: no success is claimed unless GitHub exposes an actual workflow run/check.\n- Exact next task: **recompute the live DLC/free-update source census and select the next deterministic character-only/DLC completeness mismatch or provenance correction; preserve reconciled clusters.**\n

### 2026-09-21 continuation — Free Update 1 four-attack completeness correction
- Workstream: **P1 skill DLC/free-update provenance and character-only completeness cleanup**.
- Live census before editing: **448 canonical skill records / 448 index records / 0 duplicate IDs / 0 nullable `ki_cost` values**.
- Bounded batch: **Chaos Shot, Galick Cannon, Impulse Slash, Secret Poison**.
- Research/evidence: Bandai Namco's November 21, 2016 launch-update announcement confirms four additional Free Update 1 attacks but does not name them. A contemporaneous December 2016 GameFAQs thread identifies the four TP Medal Shop additions as Chaos Shot, Galick Cannon, Impulse Slash, and Secret Poison; current dedicated skill references independently confirm each TP Medal Shop acquisition route and current mechanics/costs.
- Changes: added four canonical skill endpoints to `docs/data/skills.json`, each with `dlc_requirement=Free Update 1`, TP Medal Shop acquisition, directly evidenced Ki cost, CaC availability, and bounded provenance notes. Projected all four into `docs/data/skills-index.json`.
- Evidence limits: the official launch announcement still does not enumerate the four names; the exact name-to-Free-Update-1 mapping is therefore supported by contemporaneous player documentation plus current skill references rather than a primary publisher list. No shop price, rotation date, reward probability, Ultimate Finish condition, or narrower race/gender restriction was invented.
- Validation: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable `ki_cost` values / deterministic canonical-index ordering parity**. Category counts increased by 2 Ki Blast Supers and 2 Strike Ultimates. Newly added records and the appended cycle entry contain no internal ChatGPT citation tokens; older historical sections were not rewritten.
- CI: latest index commit `cc98212b6ace7b56df6cda78efa5c5250a6c3f88` exposes **no workflow runs and no status checks** through the repository connector; no CI success is claimed.
...
- Evidence: an independent PQ19 gameplay listing identifies Fighting Pose E as a Basic Reward, corroborating the existing PQ19 acquisition and reward-tier semantics.
...
### 2026-09-21 cycle update — Fighting Pose K low-source provenance strengthening
- Live census before editing: **452 canonical / 452 index / 44 exactly-two-source records / 0 duplicate IDs / 0 nullable `ki_cost` values**.
- Bounded batch: **Fighting Pose K (`skill-fighting-pose-k`)**.
- Research/evidence: an independent community discussion corroborates Fighting Pose K availability through the Skill Shop or a Parallel Quest. The repository's existing Fandom skill record remains the stronger source for the exact endpoint: The Ginyu Force Strikes unlocks the Skill Shop listing.
- Changes: added the independent community source to canonical `docs/data/skills.json` and `docs/data/skills-index.json`; refreshed `last_verified` to **2026-09-21**; documented the cycle in `docs/COVERAGE-AUDIT.md` and `CHANGELOG.md`.
- Evidence limits preserved: the added source does not independently establish the exact story-trigger wording, so the canonical Skill Shop-after-The Ginyu Force Strikes endpoint, 0-Ki cost, 8-second Super Armor, CaC scope, and no-Ultimate-Finish semantics were not broadened or rewritten.
- Validation target after edit: **452/452 records, 0 duplicate IDs, 0 nullable `ki_cost`, 43 exactly-two-source records**, with canonical/index source parity for Fighting Pose K.
