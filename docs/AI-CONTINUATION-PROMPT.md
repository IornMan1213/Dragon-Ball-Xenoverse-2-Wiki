...
- Validation: **452 canonical / 452 index / 0 duplicate IDs / 0 nullable `ki_cost` values / deterministic canonical-index ordering parity**. Category counts increased by 2 Ki Blast Supers and 2 Strike Ultimates. Changed files contain no internal ChatGPT citation tokens.
