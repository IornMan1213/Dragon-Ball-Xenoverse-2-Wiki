---
layout: home
title: Dragon Ball Xenoverse 2 Wiki
---
...
<section class="hero">
  <div>
    ...
    <div class="hero-actions">
      ...
      <a class="button ghost" href="{{ '/Parallel-Quests-All/' | relative_url }}">Every PQ</a>
    </div>
  </div>
  <div class="hero-card" aria-hidden="true">
    <div class="power-ring"><span>XV2</span></div>
    <p><strong>ONE HUB.</strong><br>EVERYTHING YOU NEED.</p>
  </div>
</section>

<section class="search-panel" aria-label="Wiki search">
  <div>
...
<section class="quick-grid" aria-label="Quick links">
  ...
  <a href="{{ '/Characters-All/' | relative_url }}"><b>👥 Characters</b><span>Forms, presets, unlocks, DLC, and relationships</span></a>
...
<section class="data-pulse" aria-label="Database status">
  ...
  <div class="pulse-grid">
    ...
    <a class="pulse-card" href="{{ '/Equipment-All/' | relative_url }}"><strong>NEW</strong><span>Equipment research track</span><small>Individual gear, clothing, accessories, acquisition, stats, and version provenance</small></a>
...
<section class="em-pulse" aria-label="Expert Mission database status">
  <a class="em-pulse-card" href="{{ '/Expert-Missions/' | relative_url }}">
    <div>
      <p class="eyebrow">RESEARCH TRACK</p>
      <h3>Expert Missions are indexed as a full system</h3>
...
<section class="section">
  ...
  <div class="cards">
    ...
    <a class="card" href="{{ '/Super-Souls-All/' | relative_url }}"><span class="tag">EQUIPMENT</span><h3>Super Soul Database</h3><p>Search the growing structured catalogue of triggers, effects, Limit Bursts, and acquisition routes.</p><span class="arrow">→</span></a>
    ...
    <a class="card" href="{{ '/Equipment-All/' | relative_url }}"><span class="tag">EQUIPMENT</span><h3>Equipment Database</h3><p>Clothing, accessories, native stat modifiers, acquisition routes, DLC provenance, and version history.</p><span class="arrow">→</span></a>
    ...
    <a class="card" href="{{ '/Characters-All/' | relative_url }}"><span class="tag">ROSTER</span><h3>Character Encyclopedia</h3><p>Forms, presets, unlock routes, DLC provenance, skills, and customization relationships.</p><span class="arrow">→</span></a>
  </div>
</section>
...
<section class="section">
  ...
  <div class="link-grid">
    <a href="{{ '/Characters-All/' | relative_url }}">Characters <span>→</span></a>
    <a href="{{ '/Mentors-All/' | relative_url }}">Mentors <span>→</span></a>
    <a href="{{ '/Equipment-All/' | relative_url }}">Equipment <span>→</span></a>
    ...
    <a href="{{ '/Super-Souls-All/' | relative_url }}">Super Souls <span>→</span></a>
    ...
    <a href="{{ '/Crystal-Raids/' | relative_url }}">Crystal Raids <span>→</span></a>
    <a href="{{ '/Conton-City/' | relative_url }}">Conton City <span>→</span></a>
    <a href="{{ '/Shenron-Wishes/' | relative_url }}">Shenron Wishes <span>→</span></a>
    <a href="{{ '/DLC-Overview/' | relative_url }}">DLC Overview <span>→</span></a>
    <a href="{{ '/Glitches-Bugs/' | relative_url }}">Glitches & Bugs <span>→</span></a>
    <a href="{{ '/Resources/' | relative_url }}">Resources <span>→</span></a>
  </div>
</section>
...
<section class="split-section">
  <div>
    ...
    <h2>Useful now. Better over time.</h2>
    <p>The wiki combines hard-written explanations with structured data and automated checks. The goal is not just to list content, but to explain every skill, mission, character, item, mechanic, system, and relationship in enough detail that the information remains useful when someone searches for an ordinary gameplay term.</p>
    <div class="hero-actions"><a class="button ghost" href="https://github.com/IornMan1213/Dragon-Ball-Xenoverse-2-Wiki">View the repository</a><a class="button ghost" href="{{ '/Development-History/' | relative_url }}">Development history</a></div>
  </div>
  <div class="stat-box">
    <div><strong>🔎</strong><span>Blanket full-text search</span></div>
    <div><strong>📚</strong><span>Hard-written encyclopedia</span></div>
    <div><strong>🔗</strong><span>Cross-linked records</span></div>
  </div>
</section>
