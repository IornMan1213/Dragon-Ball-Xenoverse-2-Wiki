...
<section class="section">
  ...
  <div class="cards">
    ...
    <a class="card" href="{{ '/Awoken-All/' | relative_url }}"><span class="tag">TRANSFORMATIONS</span><h3>Every Awoken Skill</h3><p>Universal and race-specific transformations with verification status.</p><span class="arrow">→</span></a>
  </div>
</section>
...
<section class="split-section">
  <div>
    ...
    <p>The wiki combines human-readable guides with structured data and automated checks so the information can keep expanding without becoming impossible to maintain.</p>
  ...
  <div class="stat-box">
    <div><strong>📚</strong><span>Guides & databases</span></div>
    <div><strong>⚡</strong><span>Fast navigation</span></div>
    <div><strong>🔧</strong><span>Community maintained</span></div>
  </div>
</section>
