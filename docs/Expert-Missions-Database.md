---
layout: wiki
title: Expert Missions Database
---
...
| Field | Purpose |
|---|---|
| Mission | EM number and title |
| Boss | Primary Super Boss |
| Unlock | Story/progression requirement |
| Rewards | TP Medals, Zeni, crystals and possible skill drops |
| Farm value | How useful the mission is for repeat runs |
| Notes | Mechanics, difficulty or special conditions |

## Progression model

1. Complete the story milestone that introduces Expert Missions.
...
|---|---|---|
| Fast TP Medals | EM 16–17 | Short repeatable runs |
| Higher medal payout | EM 18–19 | 18 medals per listed run |
| Skill/crystal hunting | Mission-specific | Reward tables vary |
| Multiplayer practice | Any suitable EM | Up to six players |
...
The next expansion should record every EM with:

- exact boss roster
- unlock condition
- TP Medal payout
- Demon Realm Crystal chance/status
- skill drops
- Super Soul/equipment drops where applicable
- time-to-clear estimates
- solo vs. co-op notes
- recommended builds

> **Verification standard:** reward values and unlock conditions should be marked verified only when supported by a mission page, game data, or a reliable current source. Community farming advice is kept separate from canonical mission data.

**Primary reference:** [Expert Mission — Xenoverse 2 Wiki](https://dbxv2.fandom.com/wiki/Expert_Mission).